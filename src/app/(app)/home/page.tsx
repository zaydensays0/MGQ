...
const features: { title: string; href: string; icon: React.ReactNode; description: string; }[] = [
  ...
  { title: 'Image to Questions', href: '/image-to-questions', icon: <ImagePlus className="w-6 h-6 text-primary" />, description: 'Generate questions from photos of your notes.' },
  ...
  { title: 'Board Saver', href: '/saved-board-questions', icon: <FileQuestion className="w-6 h-6 text-primary" />, description: 'Review questions saved from board prep.' },
